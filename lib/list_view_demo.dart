...
class SimpleListListTile extends StatelessWidget {
  const SimpleListListTile({Key? key}) : super(key: key);
...
class SimpleListBuilder extends StatelessWidget {
  ...
  // var list = List <int>.generate(50, (i) => i+1); не обязательно прописывать, т.к. itemBuilder сам итерирует список
